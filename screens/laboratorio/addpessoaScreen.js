...
export default function AddPessoaLab() {
    ...
    useEffect(() => {
        ...
        const fetchPessoas = async () => {
            try {
                ...
                const response = await fetch('https://af2a-2804-28c8-51f-f790-dd38-8be0-fdd7-4497.ngrok-free.app/usuario/listAlunos', {
                    method: 'GET',
                    headers: {
                        'Authorization': `Bearer ${token}`,
                    },
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch('https://af2a-2804-28c8-51f-f790-dd38-8be0-fdd7-4497.ngrok-free.app/espaco/adicionarPessoa', {
                method: 'PUT',
                headers: {
