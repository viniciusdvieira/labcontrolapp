...
export default function AddResponsavelLab() {
    ...
    useEffect(() => {
        ...
        const fetchServidores = async () => {
            try {
                ...
                const response = await fetch('https://e535-2804-28c8-51f-f790-dd38-8be0-fdd7-4497.ngrok-free.app/usuario/listServidor', {
                    method: 'GET',
                    headers: {
                        'Authorization': `Bearer ${token}`,
                    },
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch('https://e535-2804-28c8-51f-f790-dd38-8be0-fdd7-4497.ngrok-free.app/espaco/adicionarResponsavel', {
                method: 'PUT',
                headers: {
