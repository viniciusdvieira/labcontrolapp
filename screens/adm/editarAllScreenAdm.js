...
export default function EditarAll() {
    ...
    const fetchUserLists = async () => {
        try {
            ...
            // Fetching Admins
            const responseAdmins = await fetch('https://bcf5-2804-28c8-51f-f790-c9b-7033-4e06-acd0.ngrok-free.app/usuario/listAdm', {
                headers: {
            ...
            // Fetching Servidores
            const responseServidores = await fetch('https://bcf5-2804-28c8-51f-f790-c9b-7033-4e06-acd0.ngrok-free.app/usuario/listServidor', {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
            ...
            // Fetching Alunos
            const responseAlunos = await fetch('https://bcf5-2804-28c8-51f-f790-c9b-7033-4e06-acd0.ngrok-free.app/usuario/listAlunos', {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const handleEditarPerfil = async () => {
        try {
            ...
            const response = await fetch('https://bcf5-2804-28c8-51f-f790-c9b-7033-4e06-acd0.ngrok-free.app/usuario/atualizar/all', {
                method: 'PUT',
                headers: {
