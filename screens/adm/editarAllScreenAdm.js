...
export default function EditarAll() {
    ...
    const fetchUserLists = async () => {
        try {
            ...
            // Fetching Admins
            const responseAdmins = await fetch('https://cc4b-2804-28c8-51f-f790-a945-8bc3-2a87-5032.ngrok-free.app/usuario/listAdm', {
                headers: {
            ...
            // Fetching Servidores
            const responseServidores = await fetch('https://cc4b-2804-28c8-51f-f790-a945-8bc3-2a87-5032.ngrok-free.app/usuario/listServidor', {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
            ...
            // Fetching Alunos
            const responseAlunos = await fetch('https://cc4b-2804-28c8-51f-f790-a945-8bc3-2a87-5032.ngrok-free.app/usuario/listAlunos', {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const handleEditarPerfil = async () => {
        try {
            ...
            const response = await fetch('https://cc4b-2804-28c8-51f-f790-a945-8bc3-2a87-5032.ngrok-free.app/usuario/atualizar/all', {
                method: 'PUT',
                headers: {
