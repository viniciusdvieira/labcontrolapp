...
export default function EditarAll() {
    ...
    const fetchUserLists = async () => {
        try {
            ...
            // Fetching Admins
            const responseAdmins = await fetch('https://e40f-2804-28c8-51f-f790-dd38-8be0-fdd7-4497.ngrok-free.app/usuario/listAdm', {
                headers: {
            ...
            // Fetching Servidores
            const responseServidores = await fetch('https://e40f-2804-28c8-51f-f790-dd38-8be0-fdd7-4497.ngrok-free.app/usuario/listServidor', {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
            ...
            // Fetching Alunos
            const responseAlunos = await fetch('https://e40f-2804-28c8-51f-f790-dd38-8be0-fdd7-4497.ngrok-free.app/usuario/listAlunos', {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const handleEditarPerfil = async () => {
        try {
            ...
            const response = await fetch('https://e40f-2804-28c8-51f-f790-dd38-8be0-fdd7-4497.ngrok-free.app/usuario/atualizar/all', {
                method: 'PUT',
                headers: {
